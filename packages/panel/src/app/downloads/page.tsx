      ...
      <main className="max-w-2xl mx-auto p-4 sm:p-6 md:p-8">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] sm:text-xs px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400">
                    {d.arch}
                  </span>
                </div>
        ...
        <div className="mt-8 p-4 rounded-xl bg-zinc-900 border border-zinc-800">
          ...
          <div className="text-xs text-zinc-400 space-y-2">
            <div>
              <span className="font-medium text-zinc-300">Windows:</span>
              <ol className="list-decimal ml-4 mt-0.5 space-y-0.5">
                <li>Download and run <code className="text-[10px] bg-zinc-800 px-1 py-0.5 rounded">zmmo-agent-windows-amd64.exe</code></li>
                <li>Windows Defender may warn — click "More info" → "Run anyway"</li>
                <li>Agent starts on port 55555 — keep the terminal open</li>
              </ol>
            </div>
            <div>
              <span className="font-medium text-zinc-300">macOS:</span>
              <ol className="list-decimal ml-4 mt-0.5 space-y-0.5">
                <li>Download the binary for your Mac (Intel or Apple Silicon)</li>
                <li>Open Terminal, run: <code className="text-[10px] bg-zinc-800 px-1 py-0.5 rounded">chmod +x ~/Downloads/zmmo-agent-darwin-*</code></li>
                <li>Run: <code className="text-[10px] bg-zinc-800 px-1 py-0.5 rounded">~/Downloads/zmmo-agent-darwin-arm64</code></li>
                <li>If blocked, go to System Settings → Privacy & Security → Allow</li>
              </ol>
            </div>
            <div>
